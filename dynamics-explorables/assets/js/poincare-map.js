...
const layout = {
  ...
  xaxis: {range: [-2, 2], domain: [0.15, 0.6], showgrid: false},
...
Plotly.newPlot(
    vectorPlot, structuredClone(streamlineTraces), layout, {staticPlot: true});
...
Plotly.newPlot(
    singleTrajectory, structuredClone(streamlineTraces), layout,
    {staticPlot: true});
...
Plotly.newPlot(
    allTrajectories, structuredClone(streamlineTraces), layout,
    {staticPlot: true});
...
Plotly.newPlot(poincarePlot, [unityLine], layout2, {staticPlot: true});
